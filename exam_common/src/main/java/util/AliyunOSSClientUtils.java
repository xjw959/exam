...
public class AliyunOSSClientUtils {
	...
	//oss-cn-beijing.aliyuncs.com aisile04a.oss-cn-beijing.aliyuncs.com
	private String endpoint = "oss-cn-beijing.aliyuncs.com";
	// accessKey
	private String accessKeyId = "LTAI4Fn1gDxYGFnTGyssouJB";
	private String accessKeySecret = "v7ymasdcX6HI6vSZvausfnD1eYx8KS";
	// 空间
	private String bucketName = "xjw-959";
	// 文件存储目录
